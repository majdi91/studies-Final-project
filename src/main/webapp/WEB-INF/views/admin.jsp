...
<html>
  <head>
	...
	<link href="static/css/AdminLTE.min.css" type="text/css" media="screen, projection" rel="stylesheet" />
          ...
          <div class="navbar-custom-menu" ng-show="{{isUserLoggedIn}}">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header" ng-controller="UserController">
                    <img src="static/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                    <p>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              <a href="#/view"><i class="icon-group"></i><span>Population</span><i class="fa fa-angle-left pull-right"></i></a>
             <ul class="treeview-menu ">
                <li><a href="#/add_user"><i class="fa fa-circle-o"></i> Add User</a></li>
                <li><a href="#/update"><i class="fa fa-circle-o"></i> Update Info</a></li>
                <li><a href="#/delete"><i class="fa fa-circle-o"></i> Delete User</a></li>
                </ul>
            </li>
            
            <li>
              <a href="#/all_projects">
                <i class="icon-cogs"></i> <span>Projects</span> 
            ...
            <li class="treeview active">
              <a href="#/pay">
               ...
               <ul class="treeview-menu " >
                <li><a href="#/bill"><i class="fa fa-circle-o"></i> Prepare a Bill</a></li>
                </ul>
            </li>
            <li class="treeview">
           ...
           <li class="treeview">
              <a href="#/add">
                <i class="fa fa-plus-square"></i> <span>Place an Ad</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
