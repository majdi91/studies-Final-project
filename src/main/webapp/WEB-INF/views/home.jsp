...
<script src="static/js/jquery/jquery.selectbox-0.5.js" type="text/javascript"></script>
<script type="text/javascript">
...
$(function() {
	...
	image: "static/images/forms/upload_file.gif",
	imageheight : 29,
	imagewidth : 78,
	width : 300
	});
...
<body ng-app="myApp" ng-controller="AnnController as ctr"> 
...
<div id="page-top">
	...
	<!-- start logo -->
	<div id="logo">
	<a href=""><img src="static/images/shared/logo.png" width="156" height="40" alt="" /></a>
	</div>
	<!-- end logo -->
...
<div class="nav-outer"> 
		...
		<div id="nav-right">
			...
			<div class="showhide-account"><img src="static/images/shared/nav/nav_myaccount.gif" width="93" height="14" alt="" /></div>
			<div class="nav-divider">&nbsp;</div>
			<a href="" id="logout"><img src="static/images/shared/nav/nav_logout.gif" width="64" height="14" alt="" /></a>
			<div class="clear">&nbsp;</div>
...
<tr>
	<th rowspan="3" class="sized"><img src="static/images/shared/side_shadowleft.jpg" width="20" height="300" alt="" /></th>
	<th class="topleft"></th>
	<td id="tbl-border-top">&nbsp;</td>
	<th class="topright"></th>
	<th rowspan="3" class="sized"><img src="static/images/shared/side_shadowright.jpg" width="20" height="300" alt="" /></th>
</tr>
<tr>
	...
	<td>
		...
		<!-- start id-form -->
		<form name="form" ng-submit="ctr.createAnn(ctr.pub)" role="form">
	<div id="content-table-inner">
	...
	<td>
		...
		<tr>
			...
			<td><input type="text" class="inp-form" ng-model="ctr.pub.titre"/></td>
			<td></td>
		</tr>
		<tr>
		<th valign="top">Category:</th>
		<td>	
		<select  class="styledselect_form_1" ng-model="ctr.pub.cat">
		...
		<td class="noheight">
			...
			<tr  valign="top">
				<td>
				<form id="chooseDateForm" action="#" ng-mosel="ctr.pub.date">
				...
				<td><a href=""  id="date-pick"><img src="static/images/forms/icon_calendar.jpg"   alt="" /></a></td>
			</tr>
			</table>
	...
	<tr>
		<th valign="top">Texte de l'annonce":</th>
		<td><textarea rows="" cols="" class="form-textarea" ng-model="ctr.pub.desc"></textarea></td>
		<td></td>
	</tr>
	<tr>
	<th>Image 1:</th>
	<td><input type="file" class="file_1" ng-model="ctr.pub.img"/></td>
	<td>
	...
	<div id="related-activities">
		...
		<img src="static/images/forms/header_related_act.gif" width="271" height="43" alt="" />
		</div>
		<!-- end related-act-top -->
		...
		<div id="related-act-bottom">
			...
			<div id="related-act-inner">
				...
				<div class="left"><a href=""><img src="static/images/forms/icon_plus.gif" width="21" height="21" alt="" /></a></div>
				<div class="right">
				...
				<div class="left"><a href=""><img src="static/images/forms/icon_minus.gif" width="21" height="21" alt="" /></a></div>
				<div class="right">
				...
				<div class="left"><a href=""><img src="static/images/forms/icon_edit.gif" width="21" height="21" alt="" /></a></div>
				<div class="right">
...
<tr>
<td><img src="static/images/shared/blank.gif" width="695" height="1" alt="blank" /></td>
<td></td>
</tr>
</table>
